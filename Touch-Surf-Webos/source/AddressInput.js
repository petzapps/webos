enyo.kind({
	...
	chrome: [
		...
		{kind: "InputBox", layoutKind: "HFlexLayout", flex: 1, className: "enyo-tool-input", height: "40px", focusClassName: "enyo-tool-input-focus", spacingClassName: "enyo-tool-input-spacing", components: [
			{name: "secureLock", kind: enyo.CustomButton, showing: false, className: "secure-lock"},
			
			{name: "userinput", kind: "Input", flex: 1, style:"color:white;margin:1px;",inputType: "url",width: "100%", spellcheck: false, autocorrect: false, autoCapitalize: "lowercase", autoWordComplete: false, hint: $L("Enter URL"), selectAllOnFocus: true,
				//onfocus: "selectInput",
	...
	getUserInput: function(inRaw) {
		...
		console.log("getUserInput: url: "+value);
		if (!inRaw) {
